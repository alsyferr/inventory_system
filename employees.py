...
def connect_database():
    try:
        ...
        messagebox.showerror(
            "Error",
            "Database connectivity issue, try again, open mysql command line client",
        )
        return None, None
...
def select_data(
    ...
    index = index[0]  # Get the first selected item
    content = employee_treeview.item(index)
    row = content.get("values", [])

    if not row or len(row) < 14:
        return  # Ensure the row has enough data
    ...
    def safe_set_date(date_entry, date_str):
        try:
    ...
    safe_set_date(dob_date_entry, row[4])
    contact_entry.insert(0, row[5])
    employment_type_combobox.set(row[6])
    education_combobox.set(row[7])
    work_shift_combobox.set(row[8])
    address_text.insert(1.0, row[9])
    safe_set_date(doj_date_entry, row[10])
    salary_entry.insert(0, row[11])
    usertype_combobox.set(row[12])
    password_entry.insert(0, row[13])
...
def add_employee(
    ...
    if (
        ...
        or contact == ""
        or employment_type == "Select type"
        or education == "Select Education"
        or work_shift == "Select Shift"
        or address == "\n"
        or salary == ""
...
def employee_form(window):
    ...
    empid_label = Label(
        detail_frame, text="EmpId", font=("times new roman", 12), bg="white"
    )
    ...
    name_label = Label(
        detail_frame, text="Name", font=("times new roman", 12), bg="white"
    )
    ...
    email_label = Label(
        detail_frame, text="Email", font=("times new roman", 12), bg="white"
    )
    ...
    gender_label = Label(
        detail_frame, text="Gender", font=("times new roman", 12), bg="white"
    )
    ...
    dob_label = Label(
        detail_frame, text="Date of Birth", font=("times new roman", 12), bg="white"
    )
    ...
    contact_label = Label(
        detail_frame, text="Contact", font=("times new roman", 12), bg="white"
    )
    ...
    employment_type_label = Label(
        detail_frame, text="Employement Type", font=("times new roman", 12), bg="white"
    )
    ...
    education_label = Label(
        detail_frame, text="Education", font=("times new roman", 12), bg="white"
    )
    ...
    work_shift_label = Label(
        detail_frame, text="Work Shift", font=("times new roman", 12), bg="white"
    )
    ...
    address_label = Label(
        detail_frame, text="Address", font=("times new roman", 12), bg="white"
    )
    address_label.grid(row=3, column=0, padx=20, pady=10, sticky="w")
    address_text = Text(
        detail_frame, width=20, height=3, font=("times new roman", 12), bg="lightyellow"
    )
    address_text.grid(row=3, column=1, padx=20, pady=10, rowspan=2)

    doj_label = Label(
        detail_frame, text="Date of Joining", font=("times new roman", 12), bg="white"
    )
    doj_label.grid(row=3, column=2, padx=20, pady=10, sticky="w")
    doj_date_entry = DateEntry(
        detail_frame,
        width=18,
        font=("times new roman", 12),
        state="readonly",
    ...
    usertype_label = Label(
        detail_frame, text="User Type", font=("times new roman", 12), bg="white"
    )
    ...
    salary_label = Label(
        detail_frame, text="Salary", font=("times new roman", 12), bg="white"
    )
    ...
    password_label = Label(
        detail_frame, text="Password", font=("times new roman", 12), bg="white"
    )
